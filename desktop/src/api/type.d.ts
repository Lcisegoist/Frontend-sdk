import type {
  PerfamceReportMsg as SdkPerfamceReportMsg,
  RequestReportMsg as SdkRequestReportMsg,
  JsErrorReportMsg,
  ResourceStatus as SdkResourceStatus,
} from '@frontend-watch-dog/web-sdk';
...
declare global {
  ...
  // 把sdk内部的数据类型暴露出来
  type RequestReportMsg = SdkRequestReportMsg
  type PerfamceReportMsg = SdkPerfamceReportMsg;
  type ResourceStatus = SdkResourceStatus;
  ...
  interface Options {
    // label和value分别为时间和数量，用于echarts画图
    label: string;
    value: string | number;
  }
